...
import { completeGoogleDriveConnect } from '../services/api';
...
export function GoogleDriveCallbackPage() {
  ...
  useEffect(() => {
    const completeConnection = async () => {
      ...
      try {
        await completeGoogleDriveConnect({ code, state });
        setStatus('success');
      ...
      <div className="w-full max-w-md rounded-lg bg-white p-8 text-center shadow-md dark:bg-gray-800">
        {status === 'loading' && (
          <>
            ...
            <h2 className="mt-4 text-xl font-semibold">Connecting to Google Drive...</h2>

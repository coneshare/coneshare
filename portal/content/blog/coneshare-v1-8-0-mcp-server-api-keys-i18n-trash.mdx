...
* **Configure Remote MCP Server:** If you plan to enable AI assistants for your team, see the [Remote MCP Server configuration manual](https://docs.coneshare.com/en/mcp-server/) for Nginx reverse proxy and environment setup.
